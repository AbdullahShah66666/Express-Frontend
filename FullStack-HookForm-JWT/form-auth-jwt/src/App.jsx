    ...
    <>
      ...
      <form className="border-2 w-100 p-3 mt-1.5 flex flex-col justify-between h-70" onSubmit={handleSubmit((data) => {
        ...
        <div className="flex justify-between">
          ...
          <input className='border-yellow-300 border-2 pl-2 w-1/2 hover:w-3/5 focus:w-3/5 transition-all duration-400' {...register("userName", {
        ...
        <div className="flex justify-between">
          ...
          <input className='border-yellow-300 border-2 pl-2 w-1/2 hover:w-3/5 focus:w-3/5 transition-all duration-400' {...register("email", {
        ...
        <div className="flex justify-between">
          ...
          <input className='border-yellow-300 border-2 pl-2 w-1/2 hover:w-3/5 focus:w-3/5 transition-all duration-400' {...register("password", {
